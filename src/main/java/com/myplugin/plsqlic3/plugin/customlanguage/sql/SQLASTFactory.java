...
import com.myplugin.plsqlic3.plugin.customlanguage.sql.psi.SQLIdentifierPSINode;
 ...
 *  to override.
 */
public class SQLASTFactory extends DefaultASTFactoryImpl {
	...
	public LeafElement createLeaf(@NotNull IElementType type, CharSequence text) {
		if ( type instanceof TokenIElementType &&
			 ((TokenIElementType) type).getANTLRTokenType()==PostgreSQLLexer.Identifier)
		{
			...
			return new SQLIdentifierPSINode(type, text);
		}
