parser grammar PostgreSQLPlpgsqlInnerParser;


options { tokenVocab = PostgreSQLPlpgsqlInnerLexer;
superClass = PostgreSQLPlpgsqlInnerParserBase;
}
...
func_as locals[ParserRuleContext Definition]
   :
   /* Modified */
   DollarStringConstant plsqlroot DollarStringConstant
   /* |AS 'definition'*/
//   def = sconst
   /*| AS 'obj_file', 'link_symbol'*/
//   | sconst COMMA sconst
...
c_expr
   ...
   | aexprconst # c_expr_expr//new add
