...
import static com.myplugin.plsqlic3.plugin.customlanguage.sql.parser.PostgreSQLPlpgsqlInnerParser.RULE_identifier;
 ...
 *  of this type.
 */
public class SQLIdentifierPSINode extends ANTLRPsiLeafNode implements PsiNamedElement {
	public SQLIdentifierPSINode(IElementType type, CharSequence text) {
		super(type, text);
	}
...
//				case RULE_expr :
				case RULE_identifier :
					return new SQLVariableRef(this);
//				case RULE_call_expr :
//					return new SQLFunctionRef(this);
			}
		}
		return null;
	}
