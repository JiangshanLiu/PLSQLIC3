...
import com.myplugin.plsqlhelper.plugin.customlanguage.sample.parser.SampleLanguageLexer;
import com.myplugin.plsqlhelper.plugin.customlanguage.sample.parser.SampleLanguageParser;
...
public class SampleSyntaxHighlighter extends SyntaxHighlighterBase {
	...
	public static final TextAttributesKey ID =
		createTextAttributesKey("SQL_ID", DefaultLanguageHighlighterColors.IDENTIFIER);
	...
	public static final TextAttributesKey BLOCK_COMMENT =
		createTextAttributesKey("SQL_BLOCK_COMMENT", DefaultLanguageHighlighterColors.BLOCK_COMMENT);
